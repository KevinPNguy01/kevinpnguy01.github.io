        ...
        <section className="flex flex-wrap lg:grid lg:grid-cols-2 gap-8 items-center w-full">
            ...
            <div className="flex flex-col gap-8 items-center w-full">
                ...
                {(repoExists || websiteExists || videoExists) && (
                    <div className={`items-center justify-center gap-3 flex flex-col place-items-center md:grid *:w-full! *:h-full  ${(repoExists && websiteExists) || (repoExists && videoExists) || (websiteExists && videoExists) ? 'grid-cols-2 w-full' : 'w-full md:w-1/2 grid-cols-1'}`}>
