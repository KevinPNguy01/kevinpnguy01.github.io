  ...
  return (
    ...
    >
      <div ref={ref} className="justify-center flex flex-col items-start gap-4">
        <h2 className="text-white text-md md:text-md font-semibold">
          Introduction
        </h2>
        ...
        <div className="z-10">
          ...
          <IconButton
            target="_blank"
            href="https://www.linkedin.com/in/knkevin/"
          >
            <LinkedInIcon />
          </IconButton>
          ...
          <IconButton
            target="_blank"
            href="https://www.instagram.com/kevinpnguy/"
          >
            <InstagramIcon />
          </IconButton>
        </div>
        <div className="z-10 grid grid-cols-2 gap-4 w-48 md:gap-8 md:w-64 lg:w-72 py-4">
          <Button
            className="!rounded-lg bg-gradient-to-br from-blue-500 to-blue-700"
            variant="contained"
